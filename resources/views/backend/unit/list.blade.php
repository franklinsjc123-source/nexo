    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="d-flex justify-content-end mb-4">
                <a href="<?php echo route('addUnit') ?>" class="btn btn-primary">Add Unit</a>
            </div>
                        ...
                        $i = 0;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a data-placement="top" title="Status" data-original-title="Status" href="javascript:void(0)" onclick="changeStatus('<?php echo $row->id ?>','<?php echo ($row->status == 1) ? 0 : 1 ?>','Unit')" class="badge bg-pill bg-<?php echo ($row->status == 1) ? 'success' : 'danger' ?>">
