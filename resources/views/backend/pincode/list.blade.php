    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="d-flex justify-content-end mb-4">
                <a href="<?php echo route('addPincode') ?>" class="btn btn-primary">Add Pincode</a>
            </div>
                     ...
                     <?php
                        $i = 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="Edit" href="<?php echo route('addPincode',[$row->id]) ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil-fill"></i></a>
                                    <a data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" href="javascript:void(0)" onclick="commonDelete('<?php echo $row->id ?>','PinCode')" class="btn btn-sm btn-danger"><i class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
