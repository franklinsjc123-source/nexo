...
<div class="page">
    ...
    <table class="items-table " style="margin-top:10px">
        ...
        <tbody>
            ...
            <tr>
                <td>{{  $key+1 }}</td>
                <td class="text-left">{{  $io->shopData->shop_name ?? '-' }}</td>
            ...
            <tr class="total-row">
             ...
             <tr class="total-row">
                ...
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"></td>
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"></td>
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"><span style="font-family: DejaVu Sans, sans-serif;">₹</span> {{ number_format(round($order_details->coupon_applied_amount), 2) }}  </td>
            </tr>
            ...
            <tr class="total-row">
                ...
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"></td>
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"></td>
                <td class="text-right" style="border:1px solid #444; font-weight:bold;"><span style="font-family: DejaVu Sans, sans-serif;">₹</span>   {{ number_format(round($order_details->amount), 2) }}   </td>
            </tr>
            ...
            <td class="summary-right-outer" style="width:344px; border-left:1px solid #444; padding:0;">
                <table class="summary-inner">
                    ...
                    <?php 
                        ...
                        $is_partial = ($order_details->payment_type == 'PARTIAL' || strtolower($order_details->payment_mode) == 'cod');
                        $advance_paid = $is_partial ? ($total_order_amount * 0.30) : $total_order_amount;
                        $balance_due = $is_partial ? ($total_order_amount * 0.70) : 0;
                    ?>
                    <tr>
                        <td>Total Amount</td>
                        <td class="rb-colon">:</td>
                        <td class="rb-val text-right"><span style="font-family: DejaVu Sans, sans-serif;">₹</span> {{ number_format(round($total_order_amount), 2) }}</td>
                    </tr>
                    <?php if ($is_partial) { ?>
                    <tr>
                        <td>Advance Paid</td>
                        <td class="rb-colon">:</td>
                        <td class="rb-val text-right"><span style="font-family: DejaVu Sans, sans-serif;">₹</span> {{ number_format(round($advance_paid), 2) }}</td>
                    </tr>
                    <tr>
                        <td>Balance Amount</td>
                        <td class="rb-colon">:</td>
                        <td class="rb-val text-right"><span style="font-family: DejaVu Sans, sans-serif;">₹</span> <strong>{{ number_format(round($balance_due), 2) }}</strong></td>
                    </tr>
                    <?php } else { ?>
                    <tr>
                        <td>Payment Mode</td>
                    ...
                    <tr>
                        ...
                        <td class="rb-colon">:</td>
                        <td class="rb-val text-right"><span style="font-family: DejaVu Sans, sans-serif;">₹</span> {{ number_format(round($order_details->ship_amount), 2) }}</td>
                    </tr>
